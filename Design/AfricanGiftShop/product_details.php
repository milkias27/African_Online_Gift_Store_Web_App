...
<!-- First Child -->
    ...
    <nav class="navbar navbar-expand-sm sticky-top second-nav">
        ...
        <a class='nav-link text-light text-strong' href='#'>Welcome " . $_SESSION['username'] . "</a>
            ...
            if (!isset($_SESSION['username'])) {
                echo "<li class='nav-item'>
        <a class='nav-link text-strong text-light' href='./users_area/users_login.php'>Login</a>
      </li>";
            } else {
                echo "<li class='nav-item'>
        <a class='nav-link ttext-strong text-light' href='./users_area/logout.php'>Logout</a>
      </li>";
            }
