...
<head>
  <metta charset="UTF-8">
    ...
    <title> African Gift Shop - Checkout Page </title>
...
<nav class="navbar navbar-expand-sm navbar-dark first-nav sticky-top">
    ...
    <img src="../images/afro_logo_img.png" width="35" height="35" class="d-inline-block align-top" alt="" class="logo">African Gift Shop</a>
  ...
  <nav class="navbar navbar-expand-sm sticky-top second-nav">
    ...
    <?php 
      ...
      if(!isset($_SESSION['username'])){
        echo "<li class='nav-item'>
        <a class='nav-link text-strong text-light' href='users_login.php'>Login</a>
      </li>";
      }else{
        echo "<li class='nav-item'>
        <a class='nav-link text-strong text-light' href='logout.php'>Logout</a>
      </li>";
      }
