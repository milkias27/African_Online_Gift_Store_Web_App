...
$user_id=$run_query['user_id'];
    ...
    <div class="container text-center">
        <h2 class="text-center p-5 mt-5">Payment Options</h2>
        <div class="row d-flex justify-content-center align-items-center my-3">  
            <div class="col-md-6">         
            <a href="https://www.paypal.com/" target="_blank"><img src="../images/payment1.png" alt="paypal photo link" class="payment_img"></a>    
            </div>
            <div class="col-md-6">         
