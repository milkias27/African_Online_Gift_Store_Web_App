            ...
            <div class="col-lg-12 col-xl-12">
                <!-- <form action="" method="post"> -->
                    ...
                    <!-- <div class="mt-4 pt-2"> -->
                       ...
                       <span class="small fw-bold mt-2 pt-1 mb-1">Login in to proceed to checkout<a href="users_one_login.php"class="text-danger"> Login </a>/Don't have an account?<a href="users_registration.php"class="text-danger"> Register</a> </span>
                    </div>                
                    </div>
                </form>
            </div>
