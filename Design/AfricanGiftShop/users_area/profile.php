...
<nav class="navbar navbar-expand-sm navbar-dark first-nav sticky-top">
    ...
    <nav class="navbar navbar-expand-sm sticky-top second-nav" style= "color:white;">  
        ...
        <a class='nav-link text-light text-strong' href='#'>Welcome Guest</a>
                ...
                echo "<li class='nav-item'>
        <a class='nav-link text-light text-light' href='#'>Welcome " . $_SESSION['username'] . "</a>
      </li>";
            }
            if (!isset($_SESSION['username'])) {
                echo "<li class='nav-item'>
        <a class='nav-link text-light' href='./users_area/users_login.php'>Login</a>
      </li>";
            } else {
                echo "<li class='nav-item'>
  ...
  <div class="bg-light">
<!-- 
    <h3 class="text-center">Africa Gift Store Web Store </h3> -->
