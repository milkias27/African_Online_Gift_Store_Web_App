...
<!-- First Child -->
    ...
    <nav class="navbar navbar-expand-sm sticky-top second-nav" style= "color:white;">
        <ul class="navbar-nav me-auto">
            ...
            if (!isset($_SESSION['username'])) {
                echo "<li class='nav-item'>
        <a class='nav-link text-light'  href='./users_area/users_one_login.php'>Login</a>
      </li>";
            } else {
                echo "<li class='nav-item'>
    ...
    <div class="bg-light">
        ...
        <!-- <p class="text-center">Welcome to Africa Gift Store </p> -->
    </div>
        ...
        <div class="row p-5">
            <form action="" method="post">
                ...
                <div class="d-flex mb-5 mt-3">
                    ...
                    $result_count = mysqli_num_rows($result);
                    if ($result_count > 0) {   
                        echo "<span><h4 class='text-left'>Subtotal:&nbsp;&nbsp;&nbsp;<strong class='text-info'>$$total</strong></h4>  </span>
                        \n
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;                                                                                                                                            
                              </br>                 
                        <span text-end><input type='submit' style='height: 40px;' value='Continue Shopping' class='my_button' name='continue_shopping'> </span> &nbsp; 
                        ...
                        echo "<input type='submit' style='width: 175px' value='Continue Shopping' class='text-center my_button' name='continue_shopping'>";
                    }
