...
<nav class="navbar navbar-expand-sm navbar-dark first-nav sticky-top">
    ...
    <img src="./images/afro_logo_img.png" width="35" height="35" class="d-inline-block align-top" alt="" class="logo">Africa Gift Store  Apparel</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex" action="" method="get">
          <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search Gifts" name="search_data">
  ...
  <nav class="navbar navbar-expand-sm sticky-top second-nav">
    <ul class="navbar-nav me-auto">      
      ...
      if(!isset($_SESSION['username'])){
        echo "<li class='nav-item'>
        <a class='nav-link text-strong' style='color: #0e1111' href='./users_area/users_one_login.php'>Login</a>    
      </li>";
      }else{
        echo "<li class='nav-item'>
