    ...
    <img src="./images/afro_logo_img.png" width="35" height="35" class="d-inline-block align-top" alt="" class="logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="cart.php"><i class="fa-sharp fa-solid fa-cart-shopping "></i><sup padding:2px; font-size: 15px;'><?php cart_item();?></sup></a>
          </li>
          <li class="nav-item">
...
<!-- seond child --->
  ...
  <div class="bg-light">
<!-- 
    <h3 class="text-center">Africa Gift Store  Apparel Web Store </h3> -->
