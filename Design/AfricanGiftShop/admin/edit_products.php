...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_title" class="form-lable">Product Keywords</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image1 ?>" alt="product image1" class="product_image">
            </div>
        </div>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image2 ?>" alt="product image2" class="product_image">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image3 ?>" alt="product image3" class="product_image">
            </div>
        </div>
</div>
<div class="form-outline w-50 m-auto mb-4">
...
<div class="w-50 m-auto">
    <input style="background-color:#55c2da;" type="submit" name="edit_product" value="update product" required="required" class="btn px-3 mb-3 text-light">
</div>
</form>
</div>
...
if (isset($_POST['edit_product'])) {
    ...
    if ($product_title == '' or $product_desc == '' or $product_keywords == '' or $product_category == '' or $product_brands == '') {
        ...
        category_id='$product_category',brand_id='$product_brands',product_price='$product_price',product_image1='$product_image1', product_image2='$product_image2',
