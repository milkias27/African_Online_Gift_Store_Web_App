...
<table class="table table-bordered mt-2">
    ...
    ?>
        <tr>
            ...
            <td><a href='index.php?delete_category=<?php echo $category_id ?>' type="button" class="text-light" data-toggle="modal" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        data-dismiss="modal"><a href="./index.php?view_categories" 
