...
<h3 class="text-center">Insert Catagories</h3>
...
<div class="input-group w-10 mb-2 m-auto">
  ...
  <input type="submit" style="background-color: #55c2da;" class="border-0 p-2 my-3 text-light" name="insert_cat" value="Insert Categories">
