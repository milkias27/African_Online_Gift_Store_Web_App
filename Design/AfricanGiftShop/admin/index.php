...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark first-nav sticky-top" style="background-color: #80669d;">
 
    <!--First Child-->
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-info"> -->
      <div class="container-fluid">
      <a class="navbar-brand" href="index.php" style="font-family: cursive">
    <img src="../images/afro_logo_img.png" width="35" height="35" class="d-inline-block align-top" alt="" class="logo">Africa Gift Store</a>
    ...
    <!--second child-->
    <div class="bg-light">
      <h2 class="text-center text-strong p-2"> Manage Details</h2>
    </div>
